...
async function BeforeRoute(request: IncomingMessage, response: ServerResponseX) {
    let index = 0;
    let errorCount = 0;
...
async function AfterRoute(request: IncomingMessage, response: ServerResponseX, route: RouteValue) {
    let index = 0;
    let errorCount = 0;
